...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    protected abstract <T> T toDbDTime(LocalDateTime ldt);
    ...
    public static class Java8JdbcMealRepository extends JdbcMealRepository<LocalDateTime> {
        ...
        @Override
        protected LocalDateTime toDbDTime(LocalDateTime ldt) {
            return ldt;
        }
    }
    ...
    public static class TimestampJdbcMealRepository extends JdbcMealRepository<LocalDateTime> {
        ...
        @Override
        protected Timestamp toDbDTime(LocalDateTime ldt) {
